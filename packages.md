...
| adw-gtk-theme | polish | GTK theme for GTK3/GTK4 apps, recolored per-theme via theme/.../gtk.css. The stock Adwaita builds here hardcode their colors, so named-color overrides do nothing; adw-gtk3 is built to be recolored that way. Official `extra` repo. | pending |
